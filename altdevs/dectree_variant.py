...
class gv:
    ...
    DID NOT WORK, AND COULD NOT WORK BECAUSE graphviz ONLY
    HANDLES EVERYTHING AS STRINGS OF A DOT-LANGUAGE CODE
    THAT IS SENT AT THE END TO THE GraphViz C-SOFTWARE.
    '''
